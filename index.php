...
include('INCLUDE/data.php'); // Utilisez __DIR__ pour un chemin absolu fiable
...
<script>
  ...
  gtag('config', 'G-RYX6HF99ZS');
    ...
    <link rel="shortcut icon" href="RESOURCE/SITE_IMAGE/logo.jpeg" type="image/x-icon">
...
<body>
    <header>
        <div class="container">
            ...
            <nav>
                <ul>
                    <li ><a  style='border-bottom:2px solid #E91E89' href="<?php echo htmlspecialchars($accueil); ?>">Accueil</a></li>
